...
// 		eyeBuffer.push_back(std::make_unique<oglplus::Framebuffer>(bufferSize.w, bufferSize.h, &id));
// 	}
	
// 	return true;
// }

// void OVRManager::setRenderTarget(oglplus::Context& gl, OVRManager::RenderTarget target)
// {
// 	if (target == MIRROR) {
...
// 			// oglplus::Mat4 glproj(2 * n / (r - l), 0, (r + l) / (r - l), 0,
// 			// 				0, 2 * n / (t - b), (t + b) / (t - b), 0,
...
// void OVRManager::drawMirror(oglplus::Context& gl) {
